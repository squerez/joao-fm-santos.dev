...
export const commands: Command = [
  ...
  { cmd: "welcome", desc: "display welcome message", tab: 7 },
  { cmd: "about", desc: "about me", tab: 9 },
  { cmd: "education", desc: "my education background", tab: 5 },
  { cmd: "certifications", desc: "my certifications", tab: 0 },
  { cmd: "curriculum", desc: "my curriculum", tab: 4 },
  { cmd: "projects", desc: "projects i have built", tab: 6 },
  { cmd: "email", desc: "send me an email right now", tab: 9 },
